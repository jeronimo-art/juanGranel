...
/* harmony import */ var _linkArticle__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(4375);
...
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_linkArticle__WEBPACK_IMPORTED_MODULE_2__, _firebase__WEBPACK_IMPORTED_MODULE_7__]);
([_linkArticle__WEBPACK_IMPORTED_MODULE_2__, _firebase__WEBPACK_IMPORTED_MODULE_7__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
...
const Links = ()=>{
    ...
    const getLinks = async ()=>{
        _firebase__WEBPACK_IMPORTED_MODULE_7__.db.collection("post").onSnapshot((querySnapshot)=>{
            const docs = [];
    ...
    const onDeleteLink = async (id)=>{
        if (window.confirm("Eliminar este Articulo?")) {
            await _firebase__WEBPACK_IMPORTED_MODULE_7__.db.collection("post").doc(id).delete();
            (0,react_toastify__WEBPACK_IMPORTED_MODULE_5__.toast)("Articulos eliminado", {
                type: "error",
                autoClose: 2000
            });
        }
    ...
    const addOrEditLink = async (linkObject)=>{
        try {
            if (currentId === "") {
                await _firebase__WEBPACK_IMPORTED_MODULE_7__.db.collection("post").doc().set(linkObject);
                (0,react_toastify__WEBPACK_IMPORTED_MODULE_5__.toast)("Nuevo Articulos a\xf1adido", {
                    type: "success"
                });
            } else {
                await _firebase__WEBPACK_IMPORTED_MODULE_7__.db.collection("post").doc(currentId).update(linkObject);
                (0,react_toastify__WEBPACK_IMPORTED_MODULE_5__.toast)("Articulos actualizado", {
                    type: "info"
                });
                setCurrentId("");
            }
    ...
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
        children: [
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                ...
                children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_linkArticle__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z, {
                    addOrEditLink,
                    currentId,
                    links
                })
...
const LinksForm = (props)=>{
    ...
    const { 0: values , 1: setValues  } = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(initialStateValues);
    ...
    const handleSubmit = (e)=>{
        e.preventDefault();
        const getData = async ()=>{
            axios.get("https://prodcutosjuangranel-default-rtdb.firebaseio.com/articulos/" + values.url + ".json").then((response)=>{
        ...
        if (values.url != "" && values.name != "" && values.description != "") {
            ...
            e.preventDefault();
            fetch("https://prodcutosjuangranel-default-rtdb.firebaseio.com/articulos/" + values.url + ".json", {
                method: "PUT",
                headers: {
    ...
    const getLinkById = async (id)=>{
        const doc = await _firebase__WEBPACK_IMPORTED_MODULE_2__.db.collection("post").doc(id).get();
        setValues({
            ...doc.data()
        });
    };
    ...
    const getData = async ()=>{
        axios.post("https://prodcutosjuangranel-default-rtdb.firebaseio.com/articulos/" + values.description + ".json").then((response)=>{
            const myData = response.data;
        });
    };
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6689);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _components_articulo_link__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(7470);
...
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_components_articulo_link__WEBPACK_IMPORTED_MODULE_2__]);
_components_articulo_link__WEBPACK_IMPORTED_MODULE_2__ = (__webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__)[0];
            ...
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                ...
                children: user.email === "gerorobalino@gmail.com" ? /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                    children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
                        children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_components_articulo_link__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z, {})
                    })
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ManagerA);
...
var __webpack_exports__ = __webpack_require__.X(0, [686,676,884,246,664,228,669], () => (__webpack_exec__(6853)));
