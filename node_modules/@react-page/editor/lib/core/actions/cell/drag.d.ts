 ...
 * @return {Action}
 */
export declare const cellHover: (drag: PartialCell, hover: HoverTarget, level: number, position: PositionEnum) => CellHoverAction;
/**
...
export declare const dragActions: {
    ...
    cellHover: (drag: PartialCell, hover: HoverTarget, level: number, position: PositionEnum) => CellHoverAction;
};
