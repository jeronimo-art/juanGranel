...
export declare type SetDisplayModeAction = {
    type: typeof SET_DISPLAY_MODE;
    ts: Date;
    mode: DisplayModes;
    referenceNodeId?: string;
};
export declare type SetZoomAction = {
    type: typeof DISPLAY_SET_ZOOM;
    zoom: number;
};
export declare type SetDisplayReferenceNodeIdAction = {
    type: typeof SET_DISPLAY_REFERENCE_NODE_ID;
    ts: Date;
    referenceNodeId: string;
};
export declare type DisplayAction = SetDisplayModeAction | SetZoomAction | SetDisplayReferenceNodeIdAction;
export declare const setDisplayReferenceNodeId: (referenceNodeId?: string) => SetDisplayReferenceNodeIdAction;
/**
