...
var findSiblingRow_1 = require("./findSiblingRow");
describe('findSiblingRow', function () {
    it('returns previous row for a given cell in a simple case', function () {
        ...
        expect((0, findSiblingRow_1.findSiblingRow)(me.id, ancestors, 'previous')).toBe(previousRow);
    });
    ...
    it('returns the innermost previous row', function () {
        ...
        var ancestors = [parentRow, greatParentCell];
        expect((0, findSiblingRow_1.findSiblingRow)(me.id, ancestors, 'previous')).toBe(previousInnerRow);
    });
});
