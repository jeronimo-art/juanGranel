...
export declare const useSelector: <Selected extends unknown>(selector: (state: RootState) => Selected, equalityFn?: (previous: Selected, next: Selected) => boolean) => Selected;
