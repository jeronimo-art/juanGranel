 ...
 */
var mapNode = function (node, mapper, depth) {
    var _a, _b, _c, _d;
    ...
    if ((0, types_1.isRow)(node)) {
        ...
        var mappedChildren = (_b = mappedNode === null || mappedNode === void 0 ? void 0 : mappedNode.cells) === null || _b === void 0 ? void 0 : _b.map(function (c) { return (0, exports.mapNode)(c, mapper, depth + 1); });
        ...
        var mappedChildren = (_d = mappedNode === null || mappedNode === void 0 ? void 0 : mappedNode.rows) === null || _d === void 0 ? void 0 : _d.map(function (c) { return (0, exports.mapNode)(c, mapper, depth + 1); });
        var fullMapped = (mappedChildren === null || mappedChildren === void 0 ? void 0 : mappedChildren.length) > 0
