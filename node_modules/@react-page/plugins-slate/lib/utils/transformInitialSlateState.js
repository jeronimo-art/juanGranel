...
var transformChildren = function (defNodes) {
    return defNodes.map(function (defNode) {
        ...
        if (defNode.plugin) {
            ...
            var firstComponentPlugin = (0, flattenDeep_1.default)(slatePluginOrList).find(function (plugin) { return plugin.pluginType === 'component' || plugin; });
...
exports.default = (function (def) { return ({
